...
base_percussion = {
    ...
    "Ed Sheeran": {
        1: {
            "midi": [
                (35, 0, 1), (38, 0, 1.5), (44, 0, 1.5), (38, 1.5, .5),
                (35, 2, 1), (44, 2, 1), (38, 3, 1),
                (35, 4, 1), (38, 4, 1.5), (44, 4, 1.5), (38, 5.5, .5),
                (35, 6, 1), (44, 6, 1), (38, 7, 1),

                (35, 8, 1), (38, 8, 1.5), (44, 8, 1.5), (38, 9.5, .5),
                (35, 10, 1), (44, 10, 1), (38, 11, 1),
                (35, 12, 1), (38, 12, 1.5), (44, 12, 1.5), (38, 13.5, .5),
                (35, 14, 1), (44, 14, 1), (38, 15, 1),
            ],
            "pitches": [35, 38, 44]
        },
        2: {
            "midi": [
                (35, 0, 2), (44, 0, 1), (44, 1, .5), (44, 1.5, .5),
                (35, 2, 2), (44, 2, 1), (44, 3, .5), (44, 3.5, .5),
                (35, 4, 2), (44, 4, 1), (44, 5, .5), (44, 5.5, .5),
                (35, 6, 2), (44, 6, 1), (44, 7, .5), (44, 7.5, .5),

                (35, 8, 2), (44, 8, 1), (44, 9, .5), (44, 9.5, .5),
                (35, 10, 2), (44, 10, 1), (44, 11, .5), (44, 11.5, .5),
                (35, 12, 2), (44, 12, 1), (44, 13, .5), (44, 13.5, .5),
                (35, 14, 2), (44, 14, 1), (44, 15, .5), (44, 15.5, .5),
            ],
            "pitches": [35, 44]
        }
    }
